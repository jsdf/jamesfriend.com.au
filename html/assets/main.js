...
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+graphql+jsx+reason+rust */
var _self =
...
Prism.languages.graphql = {
  ...
  keyword: [
    {pattern: /(fragment\s+(?!on)[a-z_]\w*\s+|\.\.\.\s*)on\b/, lookbehind: !0},
...
Prism.languages.rust = {
  ...
  string: [
    {pattern: /b?r(#*)"(?:\\?.)*?"\1/, greedy: !0},
    {pattern: /b?("|')(?:\\?.)*?\1/, greedy: !0},
  ],
...
(function($) {
  $(function() {
    $(
      '#top-links-bar a, #top-links-bar .attention-seeker, .has-tooltip'
    ).tooltip();
  });
})(jQuery);
