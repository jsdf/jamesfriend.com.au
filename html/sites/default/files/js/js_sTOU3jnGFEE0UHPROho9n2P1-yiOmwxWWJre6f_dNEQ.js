(function(a, b) {
  ...
  function bE(a, b) {
    ...
    b.clearAttributes && b.clearAttributes(), b.mergeAttributes &&
      b.mergeAttributes(a), (c = b.nodeName.toLowerCase()), c === 'object'
      ? (b.parentNode && (b.outerHTML = a.outerHTML), p.support.html5Clone &&
          a.innerHTML &&
          !p.trim(b.innerHTML) &&
  ...
  function bZ(a, b) {
    return (a = b || a), p.css(a, 'display') === 'none' ||
  ...
  function b$(a, b) {
    ...
    for (; f < g; f++) {
      c = a[f];
      if (!c.style) continue;
      (e[f] = p._data(c, 'olddisplay')), b
        ? (!e[f] && c.style.display === 'none' && (c.style.display = ''), c
            .style.display === '' &&
            bZ(c) &&
  ...
  function ca(a, b, c, d) {
    ...
    for (; e < 4; e += 2)
      c === 'margin' && (f += p.css(a, c + bV[e], !0)), d
        ? (c === 'content' &&
            (f -= parseFloat(bH(a, 'padding' + bV[e])) || 0), c !== 'margin' &&
            (f -= parseFloat(bH(a, 'border' + bV[e] + 'Width')) || 0))
        : ((f += parseFloat(bH(a, 'padding' + bV[e])) || 0), c !== 'padding' &&
            (f += parseFloat(bH(a, 'border' + bV[e] + 'Width')) || 0));
    return f;
  }
  function cb(a, b, c) {
    ...
    if (d <= 0 || d == null) {
      ...
      (e = f && (p.support.boxSizingReliable || d === a.style[b])), (d =
        parseFloat(d) || 0);
    }
  ...
  function cc(a) {
    ...
    if (c === 'none' || c === '') {
      ...
      if (!bJ || !bI.createElement)
        (bJ = (bI.contentWindow || bI.contentDocument).document), bJ.write(
          '<!doctype html><html><body>'
        ), bJ.close();
      (b = bJ.body.appendChild(bJ.createElement(a))), (c = bH(
        b,
        'display'
  ...
  function cW(a, b, c) {
    var d,
      ...
      i = function() {
        ...
        for (; e < f; e++)
          j.tweens[e].run(d);
        return h.notifyWith(a, [j, d, c]), d < 1 && f
          ? c
          : (h.resolveWith(a, [j]), !1);
      },
      j = h.promise({
    ...
    return cV(j, k), p.isFunction(j.opts.start) &&
      j.opts.start.call(a, j), p.fx.timer(
      p.extend(i, {anim: j, queue: j.opts.queue, elem: a})
    ), j
  ...
  function cX(a, b) {
    var c, d, e, f, g;
    for (c in a) {
      (d = p.camelCase(c)), (e = b[d]), (f = a[c]), p.isArray(f) &&
        ((e = f[1]), (f = a[c] = f[0])), c !== d &&
        ((a[d] = f), delete a[c]), (g = p.cssHooks[d]);
      if (g && 'expand' in g) {
  ...
  function cY(a, b, c) {
    var d,
      ...
      q = a.nodeType && bZ(a);
    c.queue ||
      ((j = p._queueHooks(a, 'fx')), j.unqueued == null &&
        ((j.unqueued = 0), (k = j.empty.fire), (j.empty.fire = function() {
          j.unqueued || k();
      ...
      ((c.overflow = [m.overflow, m.overflowX, m.overflowY]), p.css(
        a,
        'display'
      ) === 'inline' &&
        p.css(a, 'float') === 'none' &&
      ...
      ((m.overflow = 'hidden'), p.support.shrinkWrapBlocks ||
        l.done(function() {
          (m.overflow =
            c.overflow[
              0
            ]), (m.overflowX = c.overflow[1]), (m.overflowY = c.overflow[2]);
        }));
    for (d in b) {
      f = b[d];
      if (cP.exec(f)) {
    ...
    g = o.length;
    if (g) {
      (h = p._data(a, 'fxshow') || p._data(a, 'fxshow', {})), q
        ? p(a).show()
        : l.done(function() {
            p(a).hide();
          }), l.done(function() {
      ...
      for (d = 0; d < g; d++)
        (e = o[d]), (i = l.createTween(e, q ? h[e] : 0)), (n[e] =
          h[e] || p.style(a, e)), e in h ||
          ((h[e] = i.start), q &&
            ((i.end = i.start), (i.start = e === 'width' || e === 'height'
              ? 1
              : 0)));
    }
  }
  ...
  (p.fn = p.prototype = {
    ...
    init: function(a, c, d) {
      ...
      if (typeof a == 'string') {
        ...
        if (f && (f[1] || !c)) {
          if (f[1])
            return (c = c instanceof p ? c[0] : c), (i = c && c.nodeType
              ? c.ownerDocument || c
              : e), (a = p.parseHTML(f[1], i, !0)), v.test(f[1]) &&
              p.isPlainObject(c) &&
    ...
    pushStack: function(a, b, c) {
      ...
      return (d.prevObject = this), (d.context = this.context), b === 'find'
        ? (d.selector = this.selector + (this.selector ? ' ' : '') + c)
        : b && (d.selector = this.selector + '.' + b + '(' + c + ')'), d;
    },
    each: function(a, b) {
    ...
    var a,
      ...
      k = !1;
    typeof h == 'boolean' &&
      ((k = h), (h = arguments[1] || {}), (i = 2)), typeof h != 'object' &&
      !p.isFunction(h) &&
      (h = {}), j === i && ((h = this), --i);
    for (; i < j; i++)
        ...
        for (c in a) {
          ...
          k && e && (p.isPlainObject(e) || (f = p.isArray(e)))
            ? (f
                ...
                : (g = d && p.isPlainObject(d) ? d : {}), (h[c] = p.extend(
                k,
                g,
                e
              )))
    ...
    parseHTML: function(a, b, c) {
      ...
      return !a || typeof a != 'string'
        ? null
        : (typeof b == 'boolean' && ((c = b), (b = 0)), (b =
            b || e), (d = v.exec(a))
            ? [b.createElement(d[1])]
            : ((d = p.buildFragment([a], b, c ? null : [])), p.merge(
                [],
    ...
    parseXML: function(c) {
      ...
      try {
        a.DOMParser
          ...
          : ((d = new ActiveXObject('Microsoft.XMLDOM')), (d.async =
              'false'), d.loadXML(c));
      } catch (f) {
        d = b;
      }
    ...
    access: function(a, c, d, e, f, g, h) {
      ...
      if (d && typeof d == 'object') {
        ...
        (i = h === b && p.isFunction(e)), j &&
          (i
            ? ((i = c), (c = function(a, b, c) {
                return i.call(p(a), c);
              }))
            : (c.call(a, e), (c = null)));
        if (c)
    ...
    if (!d) {
      ...
      if (e.readyState === 'complete') setTimeout(p.ready, 1);
        ...
        e.addEventListener('DOMContentLoaded', D, !1), a.addEventListener(
          'load',
          p.ready,
          !1
        );
      else {
        e.attachEvent('onreadystatechange', D), a.attachEvent(
          'onload',
          p.ready
        );
        var c = !1;
  ...
  (p.Callbacks = function(a) {
    ...
    var c,
      ...
      k = function(b) {
        ...
        (e = !1), i &&
          (j ? j.length && k(j.shift()) : c ? (i = []) : l.disable());
      },
      l = {
        add: function() {
          if (i) {
        ...
        fireWith: function(a, b) {
          return (b = b || []), (b = [a, b.slice ? b.slice() : b]), i &&
            (!d || j) &&
            (e ? j.push(b) : k(b)), this;
        },
        fire: function() {
        ...
        g = function(a, b, c) {
          return function(d) {
            (b[a] = this), (c[a] = arguments.length > 1
              ? k.call(arguments)
              : d), c === h ? f.notifyWith(b, c) : --e || f.resolveWith(b, c);
          };
        },
        h,
        i,
    ...
    n.setAttribute('className', 't'), (n.innerHTML =
      ...
      '*'
    )), (d = n.getElementsByTagName('a')[0]), (d.style.cssText =
      'top:1px;float:left;opacity:.5');
    if (!c || !c.length) return {};
    (f = e.createElement('select')), (g = f.appendChild(
      ...
      html5Clone: e.createElement('nav').cloneNode(!0).outerHTML !==
        '<:nav></:nav>',
      ...
      boxSizingReliable: !0,
      pixelPosition: !1,
    }), (h.checked = !0), (b.noCloneChecked = h.cloneNode(
      !0
    ...
    !n.addEventListener &&
      ...
      ), n.cloneNode(!0).fireEvent('onclick'), n.detachEvent(
        'onclick',
        m
      )), (h = e.createElement('input')), (h.value = 't'), h.setAttribute(
      'type',
      'radio'
    ), (b.radioValue = h.value === 't'), h.setAttribute(
      'checked',
      'checked'
    ), h.setAttribute('name', 't'), n.appendChild(
      h
    ), (i = e.createDocumentFragment()), i.appendChild(
      n.lastChild
    ), (b.checkClone = i
      .cloneNode(!0)
      .cloneNode(!0).lastChild.checked), (b.appendChecked =
      h.checked), i.removeChild(h), i.appendChild(n);
    if (n.attachEvent)
      for (k in {submit: !0, change: !0, focusin: !0})
        (j = 'on' + k), (l = j in n), l ||
          (n.setAttribute(j, 'return;'), (l = typeof n[j] == 'function')), (b[
          k + 'Bubbles'
        ] = l);
    return p(function() {
      var c,
  ...
  p.extend({
    ...
    hasData: function(a) {
      return (a = a.nodeType ? p.cache[a[p.expando]] : a[p.expando]), !!a &&
        !K(a);
    },
    data: function(a, c, d, e) {
      ...
      l || (j ? (a[h] = l = p.deletedIds.pop() || p.guid++) : (l = h)), k[l] ||
        ((k[l] = {}), j || (k[l].toJSON = p.noop));
      if (typeof c == 'object' || typeof c == 'function')
        e ? (k[l] = p.extend(k[l], c)) : (k[l].data = p.extend(k[l].data, c));
      return (f = k[l]), e || (f.data || (f.data = {}), (f = f.data)), d !==
        b && (f[p.camelCase(c)] = d), i
    ...
    data: function(a, c) {
      ...
      return typeof a == 'object'
        ...
        : ((d = a.split('.', 2)), (d[1] = d[1] ? '.' + d[1] : ''), (e =
            ...
            function(c) {
              if (c === b)
                return (k = this.triggerHandler('getData' + e, [d[0]])), k ===
                  b &&
                  i &&
                  ((k = p.data(i, a)), (k = J(i, a, k))), k === b && d[1]
                  ? this.data(d[0])
                  : k;
              (d[1] = c), this.each(function() {
                ...
                b.triggerHandler(
                  'setData' + e,
                  d
                ), p.data(this, a, c), b.triggerHandler('changeData' + e, d);
              });
            },
            null,
            c,
    ...
    queue: function(a, b, c) {
      var d;
      if (a)
        return (b = (b || 'fx') + 'queue'), (d = p._data(a, b)), c &&
          (!d || p.isArray(c)
    ...
    delay: function(a, b) {
      return (a = p.fx ? p.fx.speeds[a] || a : a), (b =
  ...
  p.fn.extend({
      ...
      return p.isFunction(a)
        ...
        : this.each(function() {
            if (c === 'string') {
              ...
              while ((e = i[f++]))
                (h = d ? h : !g.hasClass(e)), g[h ? 'addClass' : 'removeClass'](
                  e
                );
    ...
    val: function(a) {
      ...
      if (!arguments.length) {
        if (f)
          return (c =
            p.valHooks[f.type] || p.valHooks[f.nodeName.toLowerCase()]), c &&
            'get' in c &&
            (d = c.get(f, 'value')) !== b
            ? d
            : ((d = f.value), typeof d == 'string'
                ? d.replace(P, '')
                : d == null ? '' : d);
        return;
      }
    ...
    removeAttr: function(a, b) {
      ...
      if (b && a.nodeType === 1) {
        ...
        for (; g < d.length; g++)
          (e = d[g]), e &&
            ((c = p.propFix[e] || e), (f = T.test(e)), f ||
              p.attr(a, e, ''), a.removeAttribute(U ? e : c), f &&
              c in a &&
              (a[c] = !1));
      }
    },
    ...
    prop: function(a, c, d) {
      ...
      return (g = h !== 1 || !p.isXMLDoc(a)), g &&
        ((c = p.propFix[c] || c), (f = p.propHooks[c])), d !== b
        ? f && 'set' in f && (e = f.set(a, d, c)) !== b ? e : (a[c] = d)
    ...
    set: function(a, b, c) {
      ...
      return b === !1
        ? p.removeAttr(a, c)
        : ((d = p.propFix[c] || c), d in a && (a[d] = !0), a.setAttribute(
            c,
            c.toLowerCase()
          )), c;
    },
  }), U ||
    ((N = {name: !0, id: !0, coords: !0}), (L = p.valHooks.button = {
      get: function(a, c) {
        var d;
        return (d = a.getAttributeNode(c)), d &&
          (N[c] ? d.value !== '' : d.specified)
          ? d.value
          : b;
      },
      set: function(a, b, c) {
        ...
        return d ||
          ((d = e.createAttribute(c)), a.setAttributeNode(d)), (d.value =
          b + '');
      },
    ...
    })), p.support.enctype || (p.propFix.enctype = 'encoding'), p.support
    .checkOn ||
  ...
  (p.event = {
    add: function(a, c, d, e, f) {
      ...
      if (a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(g = p._data(a)))
        return;
      d.handler && ((o = d), (d = o.handler), (f = o.selector)), d.guid ||
        (d.guid = p.guid++), (i = g.events), i || (g.events = i = {}), (h =
        g.handle), h ||
      ...
      for (j = 0; j < c.length; j++) {
        (k = W.exec(c[j]) || []), (l = k[1]), (m = (k[2] || '')
          .split('.')
          .sort()), (r = p.event.special[l] || {}), (l =
          (f ? r.delegateType : r.bindType) || l), (r = p.event.special[l] || {
        }), (n = p.extend(
          {
            type: l,
            origType: k[1],
        ...
        r.add &&
          (r.add.call(a, n), n.handler.guid || (n.handler.guid = d.guid)), f
    ...
    remove: function(a, b, c, d, e) {
      ...
      for (f = 0; f < b.length; f++) {
        ...
        (n = p.event.special[h] || {}), (h =
          (d ? n.delegateType : n.bindType) || h), (o = m[h] || []), (k =
          o.length), (j = j
          ? new RegExp(
              '(^|\\.)' + j.split('.').sort().join('\\.(?:.*\\.|)') + '(\\.|$)'
            )
        ...
        for (l = 0; l < o.length; l++)
          (q = o[l]), (e || i === q.origType) &&
            (!c || c.guid === q.guid) &&
            (!j || j.test(q.namespace)) &&
            (!d || d === q.selector || (d === '**' && q.selector)) &&
            (o.splice(l--, 1), q.selector && o.delegateCount--, n.remove &&
              n.remove.call(a, q));
        o.length === 0 &&
          k !== o.length &&
          ((!n.teardown || n.teardown.call(a, j, r.handle) === !1) &&
            p.removeEvent(a, h, r.handle), delete m[h]);
      }
    ...
    trigger: function(c, d, f, g) {
      if (!f || (f.nodeType !== 3 && f.nodeType !== 8)) {
        ...
        s.indexOf('!') >= 0 && ((s = s.slice(0, -1)), (i = !0)), s.indexOf(
          '.'
        ...
        (c = typeof c == 'object'
          ...
          : new p.Event(
              s
            )), (c.type = s), (c.isTrigger = !0), (c.exclusive = i), (c.namespace = t.join(
          '.'
        ...
        (c.result = b), c.target || (c.target = f), (d = d != null
          ? p.makeArray(d)
        ...
        for (j = 0; j < q.length && !c.isPropagationStopped(); j++)
          (k = q[j][0]), (c.type = q[j][1]), (o =
            (p._data(k, 'events') || {})[c.type] && p._data(k, 'handle')), o &&
            o.apply(k, d), (o = m && k[m]), o &&
            p.acceptData(k) &&
            o.apply &&
            o.apply(k, d) === !1 &&
            c.preventDefault();
        return (c.type = s), !g &&
          ...
          !p.isWindow(f) &&
          ((l = f[m]), l && (f[m] = null), (p.event.triggered = s), f[
            s
          ](), (p.event.triggered = b), l && (f[m] = l)), c.result;
      }
      return;
    },
    dispatch: function(c) {
      ...
      if (q && (!c.button || c.type !== 'click'))
        for (f = c.target; f != this; f = f.parentNode || this)
          if (f.disabled !== !0 || c.type !== 'click') {
            (h = {}), (j = []);
            for (d = 0; d < q; d++)
              (l = o[d]), (m = l.selector), h[m] === b &&
                (h[m] = l.needsContext
                  ? p(m, this).index(f) >= 0
                  : p.find(m, this, null, [f]).length), h[m] && j.push(l);
      ...
      for (d = 0; d < u.length && !c.isPropagationStopped(); d++) {
        ...
        for (
          ...
          if (
            ...
            (c.data = l.data), (c.handleObj = l), (g = ((p.event.special[
              l.origType
            ] || {}).handle || l.handler)
              .apply(i.elem, r)), g !== b &&
              ((c.result = g), g === !1 &&
    ...
    mouseHooks: {
      ...
      filter: function(a, c) {
        ...
        return a.pageX == null &&
          c.clientX != null &&
          ((d = a.target.ownerDocument || e), (f = d.documentElement), (g =
            d.body), (a.pageX =
            c.clientX +
            ...
            ((f && f.clientTop) ||
              ...
              0))), !a.relatedTarget &&
          i &&
          (a.relatedTarget = i === a.target ? c.toElement : i), !a.which &&
          h !== b &&
          (a.which = h & 1 ? 1 : h & 2 ? 3 : h & 4 ? 2 : 0), a;
      },
    },
    fix: function(a) {
      ...
      for (b = g.length; b; )
        (c = g[--b]), (a[c] = d[c]);
      return a.target || (a.target = d.srcElement || e), a.target.nodeType ===
        3 &&
        (a.target = a.target.parentNode), (a.metaKey = !!a.metaKey), f.filter
        ? f.filter(a, d)
        : a;
    },
    special: {
    ...
    simulate: function(a, b, c, d) {
      ...
      d
        ...
        : p.event.dispatch.call(b, e), e.isDefaultPrevented() &&
        c.preventDefault();
    },
  }), (p.event.handle =
    p.event.dispatch), (p.removeEvent = e.removeEventListener
    ? function(a, b, c) {
        ...
        if (V.test(this.nodeName)) {
          if (this.type === 'checkbox' || this.type === 'radio')
            p.event.add(this, 'propertychange._change', function(a) {
              ...
              this._just_changed &&
                !a.isTrigger &&
                (this._just_changed = !1), p.event.simulate('change', this, a, !0);
            });
          return !1;
        }
    ...
    off: function(a, c, d) {
      ...
      if (a && a.preventDefault && a.handleObj)
        return (e = a.handleObj), p(a.delegateTarget).off(
      ...
      var b = arguments,
        ...
        e = function(c) {
          ...
          return p._data(
            ...
            'lastToggle' + a.guid,
            e + 1
          ), c.preventDefault(), b[e].apply(this, arguments) || !1;
        };
      e.guid = c;
      while (d < b.length)
        b[d++].guid = c;
    ...
    function(a, b) {
      (p.fn[b] = function(a, c) {
        return c == null && ((c = a), (a = null)), arguments.length > 0
          ? this.on(b, null, a, c)
          : this.trigger(b);
    ...
    function bh(a, b) {
      ...
      while (h) {
        ...
        c = !1;
        if ((d = N.exec(h)))
          f.push((c = new q(d.shift()))), (h = h.slice(c.length)), (c.type = d[
            0
          ].replace(L, ' '));
        for (g in e.filter)
          (d = W[g].exec(h)) &&
            (!j[g] || (d = j[g](d, r, !0))) &&
            (f.push((c = new q(d.shift()))), (h = h.slice(
              c.length
            )), (c.type = g), (c.matches = d));
        if (!c) break;
      }
    ...
    function bl(a, b, c, d, e, f) {
      return d && !d[o] && (d = bl(d)), e &&
        !e[o] &&
        (e = bl(e, f)), z(function(f, g, h, i) {
        if (f && e) return;
        var j,
          k,
          l,
      ...
      for (; i < f; i++)
        if ((c = e.relative[a[i].type])) m = [bi(bj(m), c)];
          ...
          if (c[o]) {
            ...
            return bl(
              i > 1 && bj(m),
              i > 1 && a.slice(0, i - 1).join('').replace(L, '$1'),
              c,
              i < d && bm(a.slice(i, d)),
              d < f && bm((a = a.slice(d))),
              d < f && a.join('')
    ...
    var c,
      ...
      Z = X(function(a) {
        return (a.innerHTML =
          "<a href='#'></a>"), a.firstChild && typeof a.firstChild.getAttribute !== n && a.firstChild.getAttribute('href') === '#';
      }),
      $ = X(function(a) {
      ...
      _ = X(function(a) {
        return (a.innerHTML =
          "<div class='hidden e'></div><div class='hidden'></div>"), !a.getElementsByClassName || !a.getElementsByClassName('e').length ? !1 : ((a.lastChild.className = 'e'), a.getElementsByClassName('e').length === 2);
      }),
      ba = X(function(a) {
        (a.id =
          o +
          0), (a.innerHTML = "<a name='" + o + "'></a><div name='" + o + "'></div>"), s.insertBefore(a, s.firstChild);
        var b =
          r.getElementsByName &&
    ...
    (bc.matches = function(a, b) {
      ...
      var c, d = g(a);
      return d || (b = b.toLowerCase()), (c = e.attrHandle[b])
        ? c(a)
        : d || $
            ? a.getAttribute(b)
            : ((c = a.getAttributeNode(b)), c
                ? typeof a[b] == 'boolean'
                    ? a[b] ? b : null
      ...
      preFilter: {
        ...
        CHILD: function(a) {
          return (a[1] = a[1].toLowerCase()), a[1] === 'nth'
            ? (a[2] || bc.error(a[0]), (a[3] = +(a[3]
                ? a[4] + (a[5] || 1)
                : 2 * (a[2] === 'even' || a[2] === 'odd'))), (a[4] = +(a[6] +
                a[7] || a[2] === 'odd')))
            : a[2] && bc.error(a[0]), a;
        },
        PSEUDO: function(a) {
      ...
      filter: {
        ID: d
          ...
          : function(a) {
              return (a = a.replace(V, '')), function(b) {
                var c =
                  typeof b.getAttributeNode !== n && b.getAttributeNode('id');
                return c && c.value === a;
              };
            },
        TAG: function(a) {
        ...
        PSEUDO: function(a, b) {
          ...
          return d[o]
            ? d(b)
            : d.length > 1
                ? ((c = [a, a, '', b]), e.setFilters.hasOwnProperty(
                    a.toLowerCase()
                  )
                    ? z(function(a, c) {
      ...
      (function() {
        ...
        X(function(a) {
          (a.innerHTML =
            "<select><option selected=''></option></select>"), a.querySelectorAll('[selected]').length || e.push('\\[' + E + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'), a.querySelectorAll(':checked').length || e.push(':checked');
        }), X(function(a) {
          (a.innerHTML =
            "<p test=''></p>"), a.querySelectorAll("[test^='']").length && e.push('[*^$]=' + E + '*(?:""|\'\')'), (a.innerHTML = "<input type='hidden'/>"), a.querySelectorAll(':enabled').length || e.push(':enabled', ':disabled');
        }), (e = new RegExp(e.join('|'))), (bp = function(a, d, f, g, h) {
          if (!g && !h && (!e || !e.test(a))) {
            var i, j, k = !0, l = o, m = d, n = d.nodeType === 9 && a;
            if (d.nodeType === 1 && d.nodeName.toLowerCase() !== 'object') {
              (i = bh(a)), (k = d.getAttribute('id'))
                ? (l = k.replace(c, '\\$&'))
                : d.setAttribute('id', l), (l = "[id='" + l + "'] "), (j =
                i.length);
              while (j--)
                i[j] = l + i[j].join('');
          ...
          }), (f = new RegExp(f.join('|'))), (bc.matchesSelector = function(
            b,
            c
          ) {
            c = c.replace(d, "='$1']");
      ...
      })(), (e.pseudos.nth = e.pseudos.eq), (e.filters = bq.prototype =
      e.pseudos), (e.setFilters = new bq()), (bc.attr =
      p.attr), (p.find = bc), (p.expr = bc.selectors), (p.expr[':'] =
      p.expr.pseudos), (p.unique = bc.uniqueSort), (p.text =
      bc.getText), (p.isXMLDoc = bc.isXML), (p.contains = bc.contains);
  })(a);
  var bc = /Until$/,
  ...
  p.fn.extend({
    ...
    closest: function(a, b) {
      ...
      return (f = f.length > 1 ? p.unique(f) : f), this.pushStack(
        f,
        'closest',
        a
      );
    ...
    function(a, b) {
      p.fn[a] = function(c, d) {
        ...
        return bc.test(a) || (d = c), d &&
          typeof d == 'string' &&
          (e = p.filter(d, e)), (e = this.length > 1 && !bg[a]
          ? p.unique(e)
          : e), this.length > 1 &&
          bd.test(a) &&
          (e = e.reverse()), this.pushStack(e, a, k.call(arguments).join(','));
      };
    }
  ), p.extend({
  ...
  (bz.optgroup = bz.option), (bz.tbody = bz.tfoot = bz.colgroup = bz.caption =
    bz.thead), (bz.th = bz.td), p.support.htmlSerialize ||
    ...
    remove: function(a, b) {
      ...
      for (; (c = this[d]) != null; d++)
        if (!a || p.filter(a, [c]).length)
          !b &&
            c.nodeType === 1 &&
            (p.cleanData(c.getElementsByTagName('*')), p.cleanData([
              c,
    ...
    replaceWith: function(a) {
      return bh(this[0])
        ...
        : p.isFunction(a)
            ...
            : (typeof a != 'string' &&
                (a = p(a).detach()), this.each(function() {
    ...
    domManip: function(a, c, d) {
      ...
      if (this[0]) {
        (e = p.buildFragment(a, this, k)), (g = e.fragment), (f =
          g.firstChild), g.childNodes.length === 1 && (g = f);
        if (f) {
          c = c && p.nodeName(f, 'tr');
    ...
    var f, g, h, i = a[0];
    return (c = c || e), (c = (!c.nodeType && c[0]) || c), (c =
      c.ownerDocument || c), a.length === 1 &&
      typeof i == 'string' &&
      i.length < 512 &&
      c === e &&
      i.charAt(0) === '<' &&
      ...
      ((g = !0), (f = p.fragments[i]), (h = f !== b)), f ||
      ((f = c.createDocumentFragment()), p.clean(a, c, f, d), g &&
        (p.fragments[i] = h && f)), {fragment: f, cacheable: g};
  }), (p.fragments = {}), p.each(
    {
      appendTo: 'append',
      prependTo: 'prepend',
    ...
    function(a, b) {
      p.fn[a] = function(c) {
        ...
        for (; e < h; e++)
          (d = (e > 0 ? this.clone(!0) : this).get()), p(g[e])[b](
            d
          ), (f = f.concat(d));
      ...
      for (f = 0; (h = a[f]) != null; f++) {
        ...
        if (typeof h == 'string')
          if (!br.test(h)) h = b.createTextNode(h);
            ...
            (s = s || bk(b)), (l = b.createElement('div')), s.appendChild(
              l
            ), (h = h.replace(bo, '<$1></$2>')), (i = (bp.exec(h) || ['', ''])[
              1
            ]
              .toLowerCase()), (j = bz[i] || bz._default), (k =
              j[0]), (l.innerHTML = j[1] + h + j[2]);
            while (k--)
              l = l.lastChild;
            if (!p.support.tbody) {
              (m = bq.test(h)), (n = i === 'table' && !m
      ...
      if (c) {
        ...
        for (f = 0; (h = t[f]) != null; f++)
          if (!p.nodeName(h, 'script') || !q(h))
            c.appendChild(h), typeof h.getElementsByTagName != 'undefined' &&
              ((r = p.grep(
    ...
    (p.uaMatch = function(a) {
    ...
    }), (a = p.uaMatch(g.userAgent)), (b = {}), a.browser &&
      ((b[a.browser] = !0), (b.version = a.version)), b.chrome
      ? (b.webkit = !0)
      ...
      p.extend(
        ...
        a,
        this
      ), (a.superclass = this), (a.fn = a.prototype = this()), (a.fn.constructor = a), (a.sub = this.sub), (a.fn.init = function c(
        c,
        d
      ) {
        return d &&
          d instanceof p &&
          !(d instanceof a) &&
          (d = a(d)), p.fn.init.call(this, c, d, b);
  ...
  p.fn.extend({
    ...
    style: function(a, c, d, e) {
      ...
      (c = p.cssProps[i] || (p.cssProps[i] = bY(j, i))), (h =
    ...
    css: function(a, c, d, e) {
      ...
      return (c = p.cssProps[i] || (p.cssProps[i] = bY(a.style, i))), (h =
        p.cssHooks[c] || p.cssHooks[i]), h &&
        'get' in h &&
        (f = h.get(a, !0, e)), f === b && (f = bH(a, c)), f === 'normal' &&
        c in bU &&
        (f = bU[c]), d || e !== b
    ...
    ? (bH = function(b, c) {
        ...
        return h &&
          ((d = h[c]), d === '' &&
            ...
            (d = p.style(b, c)), bQ.test(d) &&
            bO.test(c) &&
            ((e = i.width), (f = i.minWidth), (g =
              i.maxWidth), (i.minWidth = i.maxWidth = i.width = d), (d =
              h.width), (i.width = e), (i.minWidth = f), (i.maxWidth = g))), d;
      })
    : e.documentElement.currentStyle &&
        (bH = function(a, b) {
          var c, d, e = a.currentStyle && a.currentStyle[b], f = a.style;
          return e == null && f && f[b] && (e = f[b]), bQ.test(e) &&
            !bM.test(b) &&
            ((c = f.left), (d = a.runtimeStyle && a.runtimeStyle.left), d &&
              (a.runtimeStyle.left = a.currentStyle.left), (f.left = b ===
              'fontSize'
              ? '1em'
              : e), (e = f.pixelLeft + 'px'), (f.left = c), d &&
  ...
  (cj = ct.exec(ck.toLowerCase()) || []), (p.fn.load = function(a, c, d) {
    ...
    return i >= 0 &&
      ((e = a.slice(i, a.length)), (a = a.slice(0, i))), p.isFunction(c)
      ? ((d = c), (c = b))
      : c && typeof c == 'object' && (f = 'POST'), p
      .ajax({
        url: a,
        type: f,
        dataType: 'html',
    ...
    ajaxSetup: function(a, b) {
      return b ? cB(a, p.ajaxSettings) : ((b = a), (a = p.ajaxSettings)), cB(
        a,
        b
      ), a;
    },
    ...
    ajax: function(a, c) {
      function y(a, c, f, i) {
        var k, s, t, u, w, y = c;
        if (v === 2) return;
        (v = 2), h && clearTimeout(h), (g = b), (e =
          i || ''), (x.readyState = a > 0 ? 4 : 0), f && (u = cC(l, x, f));
        if ((a >= 200 && a < 300) || a === 304)
          l.ifModified &&
            ((w = x.getResponseHeader('Last-Modified')), w &&
              (p.lastModified[d] = w), (w = x.getResponseHeader('Etag')), w &&
              (p.etag[d] = w)), a === 304
            ? ((y = 'notmodified'), (k = !0))
            : ((k = cD(l, u)), (y = k.state), (s = k.data), (t =
                k.error), (k = !t));
        else {
          t = y;
          if (!y || a) (y = 'error'), a < 0 && (a = 0);
        }
        (x.status = a), (x.statusText = (c || y) + ''), k
          ...
          (n.trigger('ajaxComplete', [x, l]), --p.active ||
      ...
      o.promise(x), (x.success = x.done), (x.error = x.fail), (x.complete =
        ...
        .replace(cl, '')
        .replace(cp, cj[1] + '//')), (l.dataTypes = p
        .trim(l.dataType || '*')
        .toLowerCase()
        .split(s)), l.crossDomain == null &&
        ((i = ct.exec(l.url.toLowerCase()) || !1), (l.crossDomain =
          i &&
          i.join(':') + (i[3] ? '' : i[1] === 'http:' ? 80 : 443) !==
            cj.join(':') +
              (cj[3] ? '' : cj[1] === 'http:' ? 80 : 443))), l.data &&
        l.processData &&
        typeof l.data != 'string' &&
        (l.data = p.param(l.data, l.traditional)), cA(cv, l, c, x);
      if (v === 2) return x;
      (j = l.global), (l.type = l.type.toUpperCase()), (l.hasContent = !co.test(
        l.type
      )), j && p.active++ === 0 && p.event.trigger('ajaxStart');
      if (!l.hasContent) {
        l.data &&
          ((l.url +=
            (cq.test(l.url) ? '&' : '?') + l.data), delete l.data), (d = l.url);
        if (l.cache === !1) {
      ...
      ((l.data && l.hasContent && l.contentType !== !1) || c.contentType) &&
        x.setRequestHeader('Content-Type', l.contentType), l.ifModified &&
        ((d = d || l.url), p.lastModified[d] &&
          x.setRequestHeader('If-Modified-Since', p.lastModified[d]), p.etag[
          d
        ] &&
          x.setRequestHeader('If-None-Match', p.etag[d])), x.setRequestHeader(
        'Accept',
  ...
  p.ajaxSetup({
    ...
    if (c.dataTypes[0] === 'jsonp' || l || m)
      return (f = c.jsonpCallback = p.isFunction(c.jsonpCallback)
        ? c.jsonpCallback()
        : c.jsonpCallback), (g = a[f]), l
        ? (c.url = j.replace(cG, '$1' + f))
        : m
            ? (c.data = i.replace(cG, '$1' + f))
            : k &&
                (c.url +=
                  (cF.test(j) ? '&' : '?') + c.jsonp + '=' + f), (c.converters[
        'script json'
      ] = function() {
        ...
        (a[
          f
        ] = g), c[f] && ((c.jsonpCallback = d.jsonpCallback), cE.push(f)), h && p.isFunction(g) && g(h[0]), (h = g = b);
      }), 'script';
  }), p.ajaxSetup({
    accepts: {
    ...
    if (a.crossDomain) {
      ...
      return {
        send: function(f, g) {
          (c = e.createElement('script')), (c.async =
            'async'), a.scriptCharset && (c.charset = a.scriptCharset), (c.src =
            a.url), (c.onload = c.onreadystatechange = function(a, e) {
            if (e || !c.readyState || /loaded|complete/.test(c.readyState))
              (c.onload = c.onreadystatechange = null), d &&
                c.parentNode &&
                d.removeChild(c), (c = b), e || g(200, 'success');
      ...
      if (!c.crossDomain || p.support.cors) {
        ...
        return {
          send: function(e, f) {
            ...
            c.mimeType &&
              i.overrideMimeType &&
              i.overrideMimeType(c.mimeType), !c.crossDomain &&
              !e['X-Requested-With'] &&
            ...
            i.send((c.hasContent && c.data) || null), (d = function(a, e) {
              ...
              ? i.readyState === 4
                  ? setTimeout(d, 0)
                  : ((g = ++cK), cJ &&
                      (cI || ((cI = {}), p(a).unload(cJ)), (cI[
                        g
                      ] = d)), (i.onreadystatechange = d))
              : d();
          },
          abort: function() {
            d && d(0, 1);
  ...
  (p.Animation = p.extend(cW, {
    ...
    run: function(a) {
      ...
      return this.options.duration
        ...
        ? c.set(this)
        : cZ.propHooks._default.set(this), this;
    },
    ...
    stop: function(a, c, d) {
      ...
      return typeof a != 'string' && ((d = c), (c = a), (a = b)), c &&
        a !== !1 &&
    ...
    return (d.old = d.complete), (d.complete = function() {
      p.isFunction(d.old) && d.old.call(this), d.queue &&
  ...
  }), (p.fx.speeds = {slow: 600, fast: 200, _default: 400}), (p.fx.step = {
  }), p.expr &&
    p.expr.filters &&
  ...
  (p.fn.offset = function(a) {
    ...
    return (d = l.body) === k
      ...
      : ((c = l.documentElement), p.contains(c, k)
          ? (typeof k.getBoundingClientRect != 'undefined' &&
              (j = k.getBoundingClientRect()), (e = da(l)), (f =
              c.clientTop || d.clientTop || 0), (g =
              c.clientLeft || d.clientLeft || 0), (h =
              e.pageYOffset || c.scrollTop), (i =
              e.pageXOffset || c.scrollLeft), {
              top: j.top + h - f,
              left: j.left + i - g,
            })
          : j);
    ...
    bodyOffset: function(a) {
      ...
      return p.support.doesNotIncludeMarginInBodyOffset &&
        ((b += parseFloat(p.css(a, 'marginTop')) || 0), (c +=
    ...
    setOffset: function(a, b, c) {
      ...
      i
        ...
        : ((l = parseFloat(g) || 0), (m = parseFloat(h) || 0)), p.isFunction(
        b
      ) && (b = b.call(a, c, f)), b.top != null &&
        (j.top = b.top - f.top + l), b.left != null &&
        (j.left = b.left - f.left + m), 'using' in b
        ? b.using.call(a, j)
        : e.css(j);
    },
  }), p.fn.extend({
  ...
  }), (a.jQuery = a.$ = p), typeof define == 'function' &&
    define.amd &&
    define.amd.jQuery &&
...
!(function($) {
  ...
  Alert.prototype.close = function(e) {
    ...
    selector ||
      ((selector = $this.attr('href')), (selector =
        selector && selector.replace(/.*(?=#[^\s]*$)/, ''))), ($parent = $(
      selector
    )), e && e.preventDefault(), $parent.length ||
      ($parent = $this.hasClass('alert')
        ? $this
        : $this.parent()), $parent.trigger(
      (e = $.Event('close'))
    ), e.isDefaultPrevented() ||
      ($parent.removeClass('in'), $.support.transition &&
  ...
  (Button.prototype.setState = function(state) {
    ...
    (state += 'Text'), data.resetText || $el.data('resetText', $el[val]()), $el[
      val
    ](data[state] || this.options[state]), setTimeout(function() {
      'loadingText' == state
    ...
    $parent &&
      $parent.find('.active').removeClass('active'), this.$element.toggleClass(
      'active'
    );
  });
  var old = $.fn.button;
  ($.fn.button = function(option) {
    ...
    var $btn = $(e.target);
    $btn.hasClass('btn') || ($btn = $btn.closest('.btn')), $btn.button(
      'toggle'
    );
  });
})(window.jQuery), !(function($) {
  ...
  var Carousel = function(element, options) {
    (this.$element = $(element)), (this.options = options), 'hover' ==
      this.options.pause &&
      this.$element
  ...
  Carousel.prototype = {
    cycle: function(e) {
      return e || (this.paused = !1), this.options.interval &&
        !this.paused &&
    ...
    slide: function(type, next) {
      var e,
        ...
        that = this;
      if (
        ((this.sliding = !0), isCycling && this.pause(), ($next = $next.length
          ? $next
          : this.$element.find('.item')[fallback]()), (e = $.Event('slide', {
          relatedTarget: $next[0],
        })), !$next.hasClass('active'))
      ) {
        if ($.support.transition && this.$element.hasClass('slide')) {
          if ((this.$element.trigger(e), e.isDefaultPrevented())) return;
          $next.addClass(type), $next[0].offsetWidth, $active.addClass(
            direction
            ...
            function() {
              $next
                ...
                .addClass('active'), $active.removeClass(
          ...
          if ((this.$element.trigger(e), e.isDefaultPrevented())) return;
          $active.removeClass('active'), $next.addClass(
            'active'
  ...
  var Collapse = function(element, options) {
    (this.$element = $(element)), (this.options = $.extend(
      ...
      options
    )), this.options.parent && (this.$parent = $(this.options.parent)), this
  ...
  Collapse.prototype = {
    ...
    show: function() {
      ...
      if (!this.transitioning) {
        if (
          ((dimension = this.dimension()), (scroll = $.camelCase(
            ['scroll', dimension].join('-')
          )), (actives =
            this.$parent &&
            this.$parent.find('> .accordion-group > .in')), actives &&
            actives.length)
        ) {
          if (
            ((hasData = actives.data('collapse')), hasData &&
              hasData.transitioning)
          )
            return;
    ...
    hide: function() {
      var dimension;
      this.transitioning ||
        ((dimension = this.dimension()), this.reset(
    ...
    reset: function(size) {
      ...
      return this.$element.removeClass('collapse')[dimension](size || 'auto')[0]
        .offsetWidth, this.$element[null !== size ? 'addClass' : 'removeClass'](
        'collapse'
      ), this;
    },
    transition: function(method, startEvent, completeEvent) {
      var that = this,
        complete = function() {
          'show' == startEvent.type &&
            that.reset(), (that.transitioning = 0), that.$element.trigger(
            completeEvent
          );
        };
      this.$element.trigger(startEvent), startEvent.isDefaultPrevented() ||
        ((this.transitioning = 1), this.$element[method]('in'), $.support
          .transition && this.$element.hasClass('collapse')
  ...
  function getParent($this) {
    ...
    return selector ||
      ((selector = $this.attr('href')), (selector =
        selector &&
        /#/.test(selector) &&
        selector.replace(/.*(?=#[^\s]*$)/, ''))), ($parent = $(
      selector
    )), $parent.length || ($parent = $this.parent()), $parent;
  }
  ...
  Dropdown.prototype = {
    ...
    toggle: function() {
      ...
      if (!$this.is('.disabled, :disabled'))
        return ($parent = getParent($this)), (isActive = $parent.hasClass(
          'open'
        )), clearMenus(), isActive ||
    ...
    keydown: function(e) {
      ...
      if (
        ...
        (($this = $(this)), e.preventDefault(), e.stopPropagation(), !$this.is(
          '.disabled, :disabled'
        ))
      ) {
        if (
          (($parent = getParent($this)), (isActive = $parent.hasClass(
            'open'
        ...
        ($items = $(
          ...
          ((index = $items.index($items.filter(':focus'))), 38 == e.keyCode &&
            index > 0 &&
            index--, 40 == e.keyCode &&
            $items.length - 1 > index &&
            index++, ~index || (index = 0), $items.eq(index).focus());
      }
    },
  };
  var old = $.fn.dropdown;
  ...
  Modal.prototype = {
        ...
        ((this.isShown = !0), this.escape(), this.backdrop(function() {
          ...
          that.$element.parent().length ||
            that.$element.appendTo(
              document.body
            ), that.$element.show(), transition && that.$element[0].offsetWidth, that.$element.addClass('in').attr('aria-hidden', !1), that.enforceFocus(), transition
    ...
    hide: function(e) {
      e && e.preventDefault(), (e = $.Event('hide')), this.$element.trigger(
        e
      ), this.isShown &&
        !e.isDefaultPrevented() &&
        ((this.isShown = !1), this.escape(), $(document).off(
          'focusin.modal'
        ), this.$element.removeClass('in').attr('aria-hidden', !0), $.support
          .transition && this.$element.hasClass('fade')
    ...
    backdrop: function(callback) {
      ...
      if (this.isShown && this.options.backdrop) {
        ...
        ).appendTo(document.body)), this.$backdrop.click(
          'static' == this.options.backdrop
            ? $.proxy(this.$element[0].focus, this.$element[0])
            : $.proxy(this.hide, this)
        ), doAnimate && this.$backdrop[0].offsetWidth, this.$backdrop.addClass(
          'in'
        ), doAnimate
        ...
        !this.isShown && this.$backdrop
          ? (this.$backdrop.removeClass('in'), $.support.transition &&
  ...
  Tooltip.prototype = {
    ...
    init: function(type, element, options) {
      ...
      (this.type = type), (this.$element = $(
        element
      )), (this.options = this.getOptions(
        options
      )), (this.enabled = !0), 'click' == this.options.trigger
        ? this.$element.on(
            'click.' + this.type,
        ...
        : 'manual' != this.options.trigger &&
            ((eventIn = 'hover' == this.options.trigger
              ? 'mouseenter'
              : 'focus'), (eventOut = 'hover' == this.options.trigger
              ? 'mouseleave'
              : 'blur'), this.$element.on(
              eventIn + '.' + this.type,
              this.options.selector,
    ...
    getOptions: function(options) {
      return (options = $.extend(
        ...
        (options.delay = {show: options.delay, hide: options.delay}), options;
    },
    enter: function(e) {
      var self = $(e.currentTarget)[this.type](this._options).data(this.type);
      return self.options.delay && self.options.delay.show
        ? (clearTimeout(this.timeout), (self.hoverState =
            'in'), (this.timeout = setTimeout(function() {
            'in' == self.hoverState && self.show();
          }, self.options.delay.show)), void 0)
        : self.show();
    },
    leave: function(e) {
      var self = $(e.currentTarget)[this.type](this._options).data(this.type);
      return this.timeout && clearTimeout(this.timeout), self.options.delay &&
        self.options.delay.hide
        ? ((self.hoverState = 'out'), (this.timeout = setTimeout(function() {
            'out' == self.hoverState && self.hide();
          }, self.options.delay.hide)), void 0)
        : self.hide();
    },
    show: function() {
      var $tip, inside, pos, actualWidth, actualHeight, placement, tp;
      if (this.hasContent() && this.enabled) {
        switch ((($tip = this.tip()), this.setContent(), this.options
          .animation && $tip.addClass('fade'), (placement = 'function' ==
          typeof this.options.placement
          ? this.options.placement.call(this, $tip[0], this.$element[0])
          : this.options.placement), (inside = /in/.test(
          placement
        )), $tip
          .detach()
          .css({top: 0, left: 0, display: 'block'})
          .insertAfter(this.$element), (pos = this.getPosition(
          inside
        )), (actualWidth = $tip[0].offsetWidth), (actualHeight =
          $tip[0].offsetHeight), inside
          ? placement.split(' ')[1]
          : placement)) {
          case 'bottom':
            tp = {
    ...
    hide: function() {
      ...
      var $tip = this.tip();
      return $tip.removeClass('in'), $.support.transition &&
  ...
  ScrollSpy.prototype = {
    ...
    refresh: function() {
      ...
      (this.offsets = $([])), (this.targets = $([])), ($targets = this.$body
        .find(this.selector)
        .map(function() {
          var $el = $(this),
    ...
    activate: function(target) {
      ...
      (this.activeTarget = target), $(this.selector)
        ...
        '"]'), (active = $(selector)
        .parent('li')
        .addClass('active')), active.parent('.dropdown-menu').length &&
        (active = active
          .closest('li.dropdown')
          .addClass('active')), active.trigger('activate');
    },
  };
  ...
  Tab.prototype = {
    ...
    show: function() {
      ...
      selector ||
        ((selector = $this.attr('href')), (selector =
          selector && selector.replace(/.*(?=#[^\s]*$)/, ''))), $this
        .parent('li')
        .hasClass('active') ||
        ((previous = $ul.find('.active:last a')[0]), (e = $.Event('show', {
          relatedTarget: previous,
        })), $this.trigger(e), e.isDefaultPrevented() ||
          (($target = $(selector)), this.activate(
            $this.parent('li'),
            $ul
    ...
    activate: function(element, container, callback) {
      function next() {
        $active
          ...
          .removeClass('active'), element.addClass('active'), transition
          ? (element[0].offsetWidth, element.addClass('in'))
          : element.removeClass('fade'), element.parent('.dropdown-menu') &&
          element.closest('li.dropdown').addClass('active'), callback &&
          callback();
      }
  ...
  var Typeahead = function(element, options) {
    (this.$element = $(element)), (this.options = $.extend(
      ...
      options
    )), (this.matcher = this.options.matcher || this.matcher), (this.sorter =
      ...
      this.updater), (this.source = this.options.source), (this.$menu = $(
      this.options.menu
  ...
  Typeahead.prototype = {
    ...
    process: function(items) {
      ...
      })), (items = this.sorter(items)), items.length
    ...
    listen: function() {
      this.$element
        ...
        .on('keyup', $.proxy(this.keyup, this)), this.eventSupported(
        'keydown'
      ) &&
        this.$element.on('keydown', $.proxy(this.keydown, this)), this.$menu
    ...
    eventSupported: function(eventName) {
      ...
      return isSupported ||
        (this.$element.setAttribute(eventName, 'return;'), (isSupported =
          'function' == typeof this.$element[eventName])), isSupported;
    },
    move: function(e) {
      if (this.shown) {
        switch (e.keyCode) {
  ...
  Affix.prototype.checkPosition = function() {
    if (this.$element.is(':visible')) {
      ...
      'object' != typeof offset &&
        (offsetBottom = offsetTop = offset), 'function' == typeof offsetTop &&
        (offsetTop = offset.top()), 'function' == typeof offsetBottom &&
        (offsetBottom = offset.bottom()), (affix = null != this.unpin &&
        scrollTop + this.unpin <= position.top
        ? !1
        : null != offsetBottom &&
            position.top + this.$element.height() >= scrollHeight - offsetBottom
            ? 'bottom'
            : null != offsetTop && offsetTop >= scrollTop ? 'top' : !1), this
        .affixed !== affix &&
        ((this.affixed = affix), (this.unpin = 'bottom' == affix
  ...
  ($.fn.affix = function(option) {
    ...
    $('[data-spy="affix"]').each(function() {
      ...
      }), data.offsetBottom && (data.offset.bottom = data.offsetBottom), data.offsetTop && (data.offset.top = data.offsetTop), $spy.affix(data);
    });
  });
})(window.jQuery);
(function($) {
      ...
      if (
        ...
        $(window)
          .bind('gesturestart', function() {
            ...
            $('#viewport').attr(
              'content',
              'width=device-width,minimum-scale=1.0,maximum-scale=10.0'
            );
          })
...
var _self = 'undefined' != typeof window
  ...
  Prism = (function() {
      ...
      t = (_self.Prism = {
        ...
        languages: {
          ...
          DFS: function(e, n, a) {
            for (var r in e)
              e.hasOwnProperty(r) &&
                (n.call(e, r, e[r], a || r), 'Object' === t.util.type(e[r])
        ...
        highlightElement: function(a, r, i) {
          for (var l, o, s = a; s && !e.test(s.className); )
            s = s.parentNode;
          s &&
            ((l = (s.className.match(e) || [, ''])[1]), (o =
              t.languages[l])), (a.className =
            a.className.replace(e, '').replace(/\s+/g, ' ') +
            ' language-' +
            l), (s = a.parentNode), /pre/i.test(s.nodeName) &&
            (s.className =
          ...
          if ((t.hooks.run('before-highlight', g), r && _self.Worker)) {
            ...
            (c.onmessage = function(e) {
              (g.highlightedCode = n.stringify(
                JSON.parse(e.data),
                l
              )), t.hooks.run('before-insert', g), (g.element.innerHTML =
                g.highlightedCode), i && i.call(g.element), t.hooks.run(
                'after-highlight',
                g
                ...
                for (var p = 0; p < r.length; p++) {
                  ...
                  if (!(d instanceof a)) {
                    ...
                    if (m) {
                      ...
                      N.push(O), w && N.push(w), Array.prototype.splice.apply(
                        r,
                        N
                      );
                    }
    ...
    return (a = a[a.length - 1]), a &&
      ((t.filename = a.src), document.addEventListener &&
...
(function($) {
  $(function() {
    $('#top-links-bar a, #top-links-bar .attention-seeker').tooltip();
  });
})(jQuery);
