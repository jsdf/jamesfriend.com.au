(function(E, B) {
  ...
  function fa(a) {
    return c.isWindow(a)
      ? a
      : a.nodeType === 9 ? a.defaultView || a.parentWindow : false;
  }
  var t = E.document,
    c = (function() {
      function a() {
      ...
      if ((b in a || a[b] !== B) && e && !h) {
        ...
        if (b === 'tabIndex')
          return (b = a.getAttributeNode('tabIndex')) && b.specified
            ? b.value
            : Va.test(a.nodeName) || (Wa.test(a.nodeName) && a.href) ? 0 : B;
        return a[b];
      }
        ...
        '+': function(g, i) {
          ...
          for (var p = g.length, q; m < p; m++)
            if ((q = g[m])) {
              ...
              g[m] = n || (q && q.nodeName.toLowerCase() === i)
                ? q || false
                : q === i;
            }
          n && k.filter(i, g, true);
      ...
      filter: {
        PSEUDO: function(g, i, n, m) {
          ...
          if (q) return q(g, n, i, m);
            ...
            return (
              (g.textContent || g.innerText || k.getText([g]) || '')
                .indexOf(i[3]) >= 0
            );
          else if (p === 'not') {
            i = i[3];
        ...
        CLASS: function(g, i) {
          return (
            (' ' + (g.className || g.getAttribute('class')) + ' ').indexOf(i) >
            -1
          );
        },
        ATTR: function(g, i) {
...
(function($) {
  ...
  Drupal.theme = function(func) {
    ...
    return (Drupal.theme[func] || Drupal.theme.prototype[func])
      .apply(this, args);
  };
